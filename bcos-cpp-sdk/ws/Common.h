...
#define WEBSOCKET_CONNECTOR(LEVEL) BCOS_LOG(LEVEL) << "[WS][TOOL]"
...
#define WEBSOCKET_NODEINFO(LEVEL) BCOS_LOG(LEVEL) << "[WS][NODEINFO]"
...
using WsHandlshakeHandler = std::function<void(bcos::Error::Ptr, std::shared_ptr<WsSession>)>;
